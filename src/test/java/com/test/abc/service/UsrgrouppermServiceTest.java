...
public class UsrgrouppermServiceTest {
  private static DefaultUsrgrouppermService serviceMock;
  private static Usrgroupperm[] records;
  static Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd HH:mm:ss.S").create();

  /** Run when the class is loaded. */
  @BeforeClass
  public static void setUp() {
    serviceMock = mock(DefaultUsrgrouppermService.class);
