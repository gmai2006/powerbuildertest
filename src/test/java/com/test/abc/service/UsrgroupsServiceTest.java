...
public class UsrgroupsServiceTest {
  private static DefaultUsrgroupsService serviceMock;
  private static Usrgroups[] records;
  static Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd HH:mm:ss.S").create();

  /** Run when the class is loaded. */
  @BeforeClass
  public static void setUp() {
    serviceMock = mock(DefaultUsrgroupsService.class);
