...
public class UsrmembersServiceTest {
  private static DefaultUsrmembersService serviceMock;
  private static Usrmembers[] records;
  static Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd HH:mm:ss.S").create();

  /** Run when the class is loaded. */
  @BeforeClass
  public static void setUp() {
    serviceMock = mock(DefaultUsrmembersService.class);
