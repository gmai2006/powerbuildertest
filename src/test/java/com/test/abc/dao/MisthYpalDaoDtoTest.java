...
public class MisthYpalDaoDtoTest {
  ...
  public static void beforeClass() {
    ...
    try {
      ...
      Arrays.stream(misthFyloYpalRecords).skip(1).forEach(o -> misthFyloYpalDao.create(o));
    } catch (IOException ex) {
      ex.printStackTrace();
    }
  }
  ...
  public void testdwMisthYpalFormJob() {
    ...
    org.junit.Assert.assertTrue(
        ...
        misthYpalRecords[1].getRehireddate().getTime()
            == testResult.get(0).getRehireddate().getTime());
    org.junit.Assert.assertTrue(
        "expect equals termdate ",
        misthYpalRecords[1].getTermdate().getTime() == testResult.get(0).getTermdate().getTime());
    org.junit.Assert.assertEquals(
    ...
    org.junit.Assert.assertTrue(
        ...
        misthYpalRecords[1].getExeldate().getTime() == testResult.get(0).getExeldate().getTime());
    org.junit.Assert.assertEquals(
    ...
    org.junit.Assert.assertTrue(
        ...
        misthYpalRecords[1].getNewexeldate().getTime()
            == testResult.get(0).getNewexeldate().getTime());
  }
