...
public class UsrgrouppermDaoDtoTest {
  ...
  public static void beforeClass() {
    ...
    try {
      String json =
          FileUtils.readFileFromResource2String(usrgrouppermInputFile, Charset.defaultCharset());
      usrgrouppermRecords = gson.fromJson(json, Usrgroupperm[].class);
      Arrays.stream(usrgrouppermRecords).skip(1).forEach(o -> usrgrouppermDao.create(o));
