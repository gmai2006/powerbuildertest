...
public class MisthZpxrisiDaoDtoTest {
  ...
  public static void beforeClass() {
    ...
    try {
      String json =
          FileUtils.readFileFromResource2String(misthZpxrisiInputFile, Charset.defaultCharset());
      misthZpxrisiRecords = gson.fromJson(json, MisthZpxrisi[].class);
      Arrays.stream(misthZpxrisiRecords).skip(1).forEach(o -> misthZpxrisiDao.create(o));
  ...
  public void testpickZpxrisiNocurrent() {
    java.util.List<PickZpxrisiNocurrentDto> testResult = dtoDao.pickZpxrisiNocurrent();
