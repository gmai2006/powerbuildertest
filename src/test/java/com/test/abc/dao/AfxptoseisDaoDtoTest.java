...
public class AfxptoseisDaoDtoTest {
  ...
  public static void beforeClass() {
    ...
    try {
      String json =
          FileUtils.readFileFromResource2String(afxptoseisInputFile, Charset.defaultCharset());
      afxptoseisRecords = gson.fromJson(json, Afxptoseis[].class);
      Arrays.stream(afxptoseisRecords).skip(1).forEach(o -> afxptoseisDao.create(o));
