...
public class MisthZpyvarDaoDtoTest {
  ...
  public static void beforeClass() {
    ...
    try {
      String json =
          FileUtils.readFileFromResource2String(misthZpyvarInputFile, Charset.defaultCharset());
      misthZpyvarRecords = gson.fromJson(json, MisthZpyvar[].class);
      Arrays.stream(misthZpyvarRecords).skip(1).forEach(o -> misthZpyvarDao.create(o));
