...
public class MisthKratapodDaoDtoTest {
  ...
  public static void beforeClass() {
    ...
    try {
      ...
      Arrays.stream(misthKratapodRecords).skip(1).forEach(o -> misthKratapodDao.create(o));
  ...
  public void testdwMisthKratapodList() {
    ...
    org.junit.Assert.assertTrue(
        ...
        misthKratapodRecords[1].getApoddate().getTime()
            == testResult.get(0).getApoddate().getTime());
  }
}
