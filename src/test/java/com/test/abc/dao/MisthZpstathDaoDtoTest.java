...
public class MisthZpstathDaoDtoTest {
  ...
  public static void beforeClass() {
    ...
    try {
      String json =
          FileUtils.readFileFromResource2String(misthZpstathInputFile, Charset.defaultCharset());
      misthZpstathRecords = gson.fromJson(json, MisthZpstath[].class);
      Arrays.stream(misthZpstathRecords).skip(1).forEach(o -> misthZpstathDao.create(o));
