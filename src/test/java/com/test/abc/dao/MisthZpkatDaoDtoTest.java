...
public class MisthZpkatDaoDtoTest {
  ...
  public static void beforeClass() {
    ...
    try {
      String json =
          FileUtils.readFileFromResource2String(misthZpkatInputFile, Charset.defaultCharset());
      misthZpkatRecords = gson.fromJson(json, MisthZpkat[].class);
      Arrays.stream(misthZpkatRecords).skip(1).forEach(o -> misthZpkatDao.create(o));
