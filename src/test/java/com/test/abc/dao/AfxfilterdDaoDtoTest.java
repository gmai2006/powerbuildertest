...
public class AfxfilterdDaoDtoTest {
  ...
  public static void beforeClass() {
    ...
    try {
      String json =
          FileUtils.readFileFromResource2String(afxfilterdInputFile, Charset.defaultCharset());
      afxfilterdRecords = gson.fromJson(json, Afxfilterd[].class);
      Arrays.stream(afxfilterdRecords).skip(1).forEach(o -> afxfilterdDao.create(o));
