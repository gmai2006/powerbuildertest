...
import com.test.abc.dao.DefaultUsrmembersDao;
...
public class UsrmembersHandlerTest {
  static final String inputFile = "Usrmembers.json";
  static UsrmembersHandler handler;
  private static JpaDao jpa;
  static Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd HH:mm:ss.S").create();
  private Usrmembers[] records;
  ...
  public void testSelect() throws IOException {
    ...
    Usrmembers testResult = jpa.find(Usrmembers.class, records[0].getKoduser());
