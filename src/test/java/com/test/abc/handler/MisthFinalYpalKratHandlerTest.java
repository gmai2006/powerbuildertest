...
public class MisthFinalYpalKratHandlerTest {
  ...
  public void testSelect() throws IOException {
    ...
    MisthFinalYpalKrat testResult = jpa.find(MisthFinalYpalKrat.class, records[0].getId());
    assertEquals(
  ...
  private File createRecordInputStreamFromJsonFile(String inputFile, Charset charset) {
    try {
      ...
      String json = FileUtils.readFileFromResource2String(inputFile, Charset.defaultCharset());
      final MisthFinalYpalKrat[] records = gson.fromJson(json, MisthFinalYpalKrat[].class);
      String header =
          createHeader(
  ...
  private String createCsvRecord(final MisthFinalYpalKrat record) {
