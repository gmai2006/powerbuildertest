...
import com.test.abc.dao.DefaultUsrappsDao;
...
public class UsrappsHandlerTest {
  static final String inputFile = "Usrapps.json";
  static UsrappsHandler handler;
  private JpaDao jpa;
  static Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd HH:mm:ss.S").create();
  private Usrapps[] records;
  ...
  private File createRecordInputStreamFromJsonFile(String inputFile, Charset charset) {
    try {
      ...
      String json = FileUtils.readFileFromResource2String(inputFile, Charset.defaultCharset());
      final Usrapps[] records = gson.fromJson(json, Usrapps[].class);
      String header =
          createHeader(
