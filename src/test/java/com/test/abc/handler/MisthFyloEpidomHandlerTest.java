...
import com.test.abc.dao.DefaultMisthFyloEpidomDao;
...
public class MisthFyloEpidomHandlerTest {
  static final String inputFile = "MisthFyloEpidom.json";
  static MisthFyloEpidomHandler handler;
  private JpaDao jpa;
  static Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd HH:mm:ss.S").create();
  private MisthFyloEpidom[] records;
  ...
  public void testSelect() throws IOException {
    ...
    MisthFyloEpidom testResult = jpa.find(MisthFyloEpidom.class, records[0].getKodepidom());
    assertEquals(
  ...
  private File createRecordInputStreamFromJsonFile(String inputFile, Charset charset) {
    try {
      ...
      String json = FileUtils.readFileFromResource2String(inputFile, Charset.defaultCharset());
      final MisthFyloEpidom[] records = gson.fromJson(json, MisthFyloEpidom[].class);
      String header =
          createHeader(
  ...
  private String createCsvRecord(final MisthFyloEpidom record) {
