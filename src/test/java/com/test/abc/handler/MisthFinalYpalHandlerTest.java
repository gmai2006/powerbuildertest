...
public class MisthFinalYpalHandlerTest {
  ...
  public void testSelect() throws IOException {
    ...
    MisthFinalYpal testResult = jpa.find(MisthFinalYpal.class, records[0].getId());
  ...
  private File createRecordInputStreamFromJsonFile(String inputFile, Charset charset) {
    try {
      ...
      String json = FileUtils.readFileFromResource2String(inputFile, Charset.defaultCharset());
      final MisthFinalYpal[] records = gson.fromJson(json, MisthFinalYpal[].class);
      String header =
          createHeader(
  ...
  private String createCsvRecord(final MisthFinalYpal record) {
    return TestUtils.getObject(record.getId())
        ...
        + ","
        + TestUtils.getDateObject(record.getPlirdate());
  }
