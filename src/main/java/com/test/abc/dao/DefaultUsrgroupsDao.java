...
public class DefaultUsrgroupsDao implements UsrgroupsDao {
  ...
  @Inject
  @Named("DefaultJpaDao")
  public DefaultUsrgroupsDao(JpaDao dao) {
    this.dao = dao;
  }

  public DefaultUsrgroupsDao() {}
  ...
  /** {@inheritDoc} */
  @Override
  public List<Usrgroups> select(int max) {
    return dao.select("select a from Usrgroups a", Usrgroups.class, max);
  }

  /** {@inheritDoc} */
  @Override
  public List<Usrgroups> selectAll() {
    return dao.selectAll("select a from Usrgroups a", Usrgroups.class);
  }
