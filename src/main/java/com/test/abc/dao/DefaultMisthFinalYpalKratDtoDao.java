...
@Stateless
@Named("DefaultMisthFinalYpalKratDtoDao")
public class DefaultMisthFinalYpalKratDtoDao implements MisthFinalYpalKratDtoDao {
  private final Logger logger = Logger.getLogger(this.getClass().getName());
  private JpaDao dao;

  @Inject
  @Named("DefaultJpaDao")
  public DefaultMisthFinalYpalKratDtoDao(JpaDao dao) {
    this.dao = dao;
  }
