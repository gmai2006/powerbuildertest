...
public class DefaultMisthFinalYpalEpidomDao implements MisthFinalYpalEpidomDao {
  ...
  @Inject
  @Named("DefaultJpaDao")
  public DefaultMisthFinalYpalEpidomDao(JpaDao dao) {
    this.dao = dao;
  }

  public DefaultMisthFinalYpalEpidomDao() {}
  ...
  /** {@inheritDoc} */
  @Override
  public List<MisthFinalYpalEpidom> select(int max) {
    return dao.select("select a from MisthFinalYpalEpidom a", MisthFinalYpalEpidom.class, max);
  }

  /** {@inheritDoc} */
  @Override
  public List<MisthFinalYpalEpidom> selectAll() {
    return dao.selectAll("select a from MisthFinalYpalEpidom a", MisthFinalYpalEpidom.class);
  }
