...
public class DefaultUsrgrouppermDao implements UsrgrouppermDao {
  ...
  @Inject
  @Named("DefaultJpaDao")
  public DefaultUsrgrouppermDao(JpaDao dao) {
    this.dao = dao;
  }

  public DefaultUsrgrouppermDao() {}
  ...
  /** {@inheritDoc} */
  @Override
  public List<Usrgroupperm> select(int max) {
    return dao.select("select a from Usrgroupperm a", Usrgroupperm.class, max);
  }

  /** {@inheritDoc} */
  @Override
  public List<Usrgroupperm> selectAll() {
    return dao.selectAll("select a from Usrgroupperm a", Usrgroupperm.class);
  }
