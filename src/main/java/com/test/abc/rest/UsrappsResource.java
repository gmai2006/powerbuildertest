...
public class UsrappsResource {
  ...
  /**
   * Idempotent method - create or update Usrapps.
   *
   * @param obj The Usrapps be be persisted.
   * @return The Usrapps entity.
   */
  @PUT
  @Consumes(MediaType.APPLICATION_JSON)
  public Usrapps createOrUpdate(Usrapps obj) {
   ...
   */
  /**
   * @GET @Path("{id}") public Response find(@PathParam("id") String id) { Usrapps result =
