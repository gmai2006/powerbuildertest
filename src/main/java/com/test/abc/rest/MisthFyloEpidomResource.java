...
import com.test.abc.service.MisthFyloEpidomService;
import com.test.abc.entity.MisthFyloEpidom;

@Path("/misthfyloepidom")
...
public class MisthFyloEpidomResource {

  @Inject private MisthFyloEpidomService service;

  public MisthFyloEpidomResource() {}

  public MisthFyloEpidomResource(final MisthFyloEpidomService service) {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @POST
  public MisthFyloEpidom update(MisthFyloEpidom obj) {
    return this.service.update(obj);
  }

  /**
   * Delete existing MisthFyloEpidom.
   *
   * @param id instance of MisthFyloEpidom.
   * @return MisthFyloEpidom.
   */
   ...
   */
  /**
   * Select all MisthFyloEpidom with limit of returned records.
   *
   * @param max - number of records.
   * @return a list MisthFyloEpidom.
   */
  @GET
  @Path("select/{max}")
  public Response findWithLimit(@PathParam("max") String max) {
    ...
    List<MisthFyloEpidom> result = service.select(input);
  ...
  /**
   * Select all MisthFyloEpidom records.
   *
   * @return a list MisthFyloEpidom.
   */
  @GET
  ...
  public Response selectAll() {
    List<MisthFyloEpidom> result = service.selectAll();
