...
public class MisthZptmimaResource {
  ...
  /**
   * Idempotent method - create or update MisthZptmima.
   *
   * @param obj The MisthZptmima be be persisted.
   * @return The MisthZptmima entity.
   */
  @PUT
  @Consumes(MediaType.APPLICATION_JSON)
  public MisthZptmima createOrUpdate(MisthZptmima obj) {
   ...
   */
  /**
   * @GET @Path("{id}") public Response find(@PathParam("id") String id) { MisthZptmima result =
