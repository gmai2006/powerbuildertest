...
// @Stateless
@Named("MisthZpepidomHandler")
public class MisthZpepidomHandler extends DelimiterFileHandler<MisthZpepidom> {

  @Inject
  @Named("DefaultJpaDao")
  public MisthZpepidomHandler(final JpaDao dao) {
    super(dao);
  }

  @Override
  protected MisthZpepidom parseLine(List<String> headers, List<String> tokens) {
