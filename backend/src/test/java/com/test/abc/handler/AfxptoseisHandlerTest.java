...
import com.test.abc.dao.DefaultAfxptoseisDao;
...
public class AfxptoseisHandlerTest {
  ...
  public void testSelect() throws IOException {
    ...
    Afxptoseis testResult = jpa.find(Afxptoseis.class, records[0].getAit());
    assertEquals("expect equals gen ", this.records[0].getGen(), testResult.getGen());
    assertEquals("expect equals onom ", this.records[0].getOnom(), testResult.getOnom());
  }
